...
> 값이 바뀔 때마다 이 문서를 갱신하고, 트랙을 넘는 변경(예: 배포 도메인 변경)은 `../../docs/07_DECISIONS.md`에도 기록.
...
| 항목 | 값 |
|---|---|
| 배포처 | `[확인필요]` (03_PROJECT_GUIDE Week 1 결정 — GitHub Pages / Vercel 등) |
| 배포 URL (dev) | `[확인필요]` |
...
| 권한 | 범위 |
|---|---|
| Account 필드 접근 | `[확인필요]` (04_DATA_CONTRACT.md의 필드만 Edit 허용, 나머지 금지) |
