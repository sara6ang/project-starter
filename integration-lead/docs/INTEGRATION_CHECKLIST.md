...
- [ ] `../../docs/04_DATA_CONTRACT.md` 필드 레벨 합의 완료 (Store PO·Org PO·PM과)
- [ ] TongssApp 배포처 확정 (03_PROJECT_GUIDE Week 1 필수 결정)
...
- [ ] 실제 필드 전체(04_DATA_CONTRACT §3) 전송 확인
...
- [ ] 잔여 이슈는 Platform Lead와 함께 해결 (03_PROJECT_GUIDE 협업 매트릭스)
