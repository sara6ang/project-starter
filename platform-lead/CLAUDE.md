...
> 루트 규칙은 `../CLAUDE.md` 참조. 이 폴더는 `docs/06_PROJECT_TREE.md`에서 설명하듯, org 권한/설정과 제품 전체 QA — **두 스택을 가로지르는 역할**을 위한 공간입니다.
...
2. QA 체크리스트는 **02_PRD의 Demo Day 성공 기준**과 **01_PERSONAS의 각 페르소나 성공 정의**를 기준으로 작성 — 임의의 테스트케이스를 추가하기보다 이 두 문서에서 도출할 것.
