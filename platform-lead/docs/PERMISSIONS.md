...
값이 바뀔 때마다 이 문서를 갱신하고, 트랙을 넘는 변경은 `../../docs/08_DECISIONS.md`에도 기록.
...
|---|---|---|---|---|
| `[확인필요]` Is_Active 계산 | Scheduled Flow (후보) | 매일 1회 | `Last_Manual_Updated__c` 기준으로 `Is_Active__c` 갱신 | Flow vs Apex 결정 세션(04_ROADMAP Week 1) 결과 반영 |
