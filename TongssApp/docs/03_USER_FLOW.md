...
> **문서 소유권:** 최종 수정 권한은 **Store PO**. 아래는 PM이 제시하는 초안이며, 공유 `../../docs/02_USER_FLOW.md`(전체 여정 — 이대표→김스태프→박세일즈→박오너)의 1~2단계를 TongssApp 화면 단위로 상세화한 것.
...
할 수 있는 것:
- 사진 찍고 제목만 입력해도 저장 가능 (5분 이내 목표 — 00_PRODUCT_GUIDE)
- 카드 클릭 → 수정 화면
```
