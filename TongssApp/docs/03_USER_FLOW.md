# store-app/docs/03_USER_FLOW — 사용자 흐름

> **문서 소유권:** 최종 수정 권한은 **Store PO**. 아래는 PM이 제시하는 초안이며, 공유 `../../docs/03_USER_FLOW.md`(전체 여정 — 이대표→김스태프→박세일즈→박오너)의 1~2단계를 store-app 화면 단위로 상세화한 것.
