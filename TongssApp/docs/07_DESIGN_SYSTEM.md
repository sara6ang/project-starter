...
**Tongss 적용 지침:** `--color-warning`은 재고 부족 알림, `--color-success`는 체크리스트/학습 완료 표시에 우선 배정. 감정을 과도하게 자극하는 색(강한 빨강 등)은 김스태프 화면에서 "혼나는 느낌"을 줄 수 있으니 지양 (../../docs/07_VOICE_AND_TONE.md §2 Reassuring 원칙).
